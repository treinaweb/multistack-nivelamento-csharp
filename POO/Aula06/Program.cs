...
var horaInicio = new DateTime(2023, 6, 1, 10, 0, 0);
var horaTermino = new DateTime(2023, 6, 1, 12, 0, 0);
var atendimento = diarista.Atender(cliente, horaInicio, horaTermino);
Console.WriteLine(atendimento.Cliente.Nome);
Console.WriteLine(atendimento.Diarista.Nome);
Console.WriteLine(atendimento.Horas);
...
interface IAtendente
{
    ...
    Atendimento Atender(Cliente cliente, DateTime horaInicio, DateTime horaTermino);
...
class Diarista : Pessoa, IAtendente
{
    ...
    public Atendimento Atender(Cliente cliente, DateTime horaInicio, DateTime horaTermino)
    {
        var diferenca = horaTermino - horaInicio;
        return new Atendimento(cliente, this, Convert.ToInt32(diferenca.TotalHours));
    }
}
